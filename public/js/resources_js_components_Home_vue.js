...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    handleChange: function handleChange() {
      var totalExpenses = this.expenses.reduce(function (prevVal, currVal) {
        return parseInt(prevVal) + parseInt(currVal);
      }, 0);
      var percentage = parseInt(totalExpenses / this.monthlyIncome * 100);
  ...
  return _c("div", { staticClass: "container mt-4" }, [
    _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "col text-center" }, [
        _c("h1", [_vm._v("Budget Calculator")]),
        _vm._v(" "),
        _c("h3", [_vm._v("Leftover Budget")]),
        _vm._v(" "),
        _c(
          "span",
          {
            staticClass: "fs-2",
            class: {
              greenText: _vm.leftoverBudget >= 0,
              redText: _vm.leftoverBudget < 0,
            },
          },
          [_vm._v(_vm._s(_vm.leftoverBudget))]
        ),
      ]),
    ]),
    _vm._v(" "),
    _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "col-4 mb-2" }, [
        ...
        _c("input", {
          ...
          domProps: { value: _vm.monthlyIncome },
          on: {
            ...
            input: function ($event) {
              ...
              _vm.monthlyIncome = $event.target.value
            },
          },
        }),
      ]),
          ...
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.expenses[0],
              expression: "expenses[0]",
            },
          ],
          staticClass: "form-control",
          attrs: { type: "number", name: "water", id: "water" },
          domProps: { value: _vm.expenses[0] },
          on: {
            change: _vm.handleChange,
            input: function ($event) {
              if ($event.target.composing) {
              ...
              _vm.$set(_vm.expenses, 0, $event.target.value)
            },
          },
        }),
        _vm._v(" "),
        _c("h4", [_vm._v("Light Service")]),
        _vm._v(" "),
        _c("input", {
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.expenses[1],
              expression: "expenses[1]",
            },
          ],
          staticClass: "form-control",
          attrs: { type: "number", name: "light", id: "light" },
          domProps: { value: _vm.expenses[1] },
          on: {
            change: _vm.handleChange,
            input: function ($event) {
              if ($event.target.composing) {
              ...
              _vm.$set(_vm.expenses, 1, $event.target.value)
            },
          },
        }),
        _vm._v(" "),
        _c("h4", [_vm._v("Gas Service")]),
        _vm._v(" "),
        _c("input", {
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.expenses[2],
              expression: "expenses[2]",
            },
          ],
          staticClass: "form-control",
          attrs: { type: "number", name: "gas", id: "gas" },
          domProps: { value: _vm.expenses[2] },
          on: {
            change: _vm.handleChange,
            input: function ($event) {
              if ($event.target.composing) {
              ...
              _vm.$set(_vm.expenses, 2, $event.target.value)
            },
          },
        }),
        _vm._v(" "),
          ...
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.expenses[6],
              expression: "expenses[6]",
            },
          ],
          staticClass: "form-control",
          attrs: { type: "number", name: "other", id: "other" },
          domProps: { value: _vm.expenses[6] },
          on: {
            change: _vm.handleChange,
            input: function ($event) {
              if ($event.target.composing) {
              ...
              _vm.$set(_vm.expenses, 6, $event.target.value)
            },
          },
        }),
      ]),
          ...
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.expenses[3],
              expression: "expenses[3]",
            },
          ],
          staticClass: "form-control",
          attrs: { type: "number", name: "phone", id: "phone" },
          domProps: { value: _vm.expenses[3] },
          on: {
            change: _vm.handleChange,
            input: function ($event) {
              if ($event.target.composing) {
              ...
              _vm.$set(_vm.expenses, 3, $event.target.value)
            },
          },
        }),
        _vm._v(" "),
        _c("h4", [_vm._v("Outings")]),
        _vm._v(" "),
        _c("input", {
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.expenses[4],
              expression: "expenses[4]",
            },
          ],
          staticClass: "form-control",
          attrs: { type: "number", name: "outs", id: "outs" },
          domProps: { value: _vm.expenses[4] },
          on: {
            change: _vm.handleChange,
            input: function ($event) {
              if ($event.target.composing) {
              ...
              _vm.$set(_vm.expenses, 4, $event.target.value)
            },
          },
        }),
        _vm._v(" "),
        _c("h4", [_vm._v("Car Fuel")]),
        _vm._v(" "),
        _c("input", {
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.expenses[5],
              expression: "expenses[5]",
            },
          ],
          staticClass: "form-control",
          attrs: { type: "number", name: "fuel", id: "fuel" },
          domProps: { value: _vm.expenses[5] },
          on: {
            change: _vm.handleChange,
            input: function ($event) {
              if ($event.target.composing) {
              ...
              _vm.$set(_vm.expenses, 5, $event.target.value)
            },
          },
        }),
      ]),
    ...
    _vm._v(" "),
    _c("div", { staticClass: "progress", staticStyle: { height: "25px" } }, [
      _c(
        "div",
        {
          staticClass: "progress-bar",
          class: {
            "bg-warning": _vm.expensesPctg > 75,
            "bg-danger": _vm.expensesPctg > 90,
          },
